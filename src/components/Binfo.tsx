    ...
    <>
      <div className="bg-gray-50 pt-25 flex flex-col md:flex-row items-start gap-10 px-6">
        <div className="w-full md:w-1/2 md:ml-[30px]">
          ...
          <p className="font-light text-[#2d2e32] pt-6">
            I’m Mahin Rajput, a web developer trying to make the internet a
            slightly less broken place — one pixel at a time.
          </p>
      ...
      <div className="bg-gray-50 w-full md: h-40">
        <ul className="flex flex-wrap pt-10 md:ml-[45px] space-x-4">
          <li className="tiktok-sans-n1 font-light text-[#2d2e32] text-xl pr-[25px] border-r-2 border-gray-500">
            Tech Stack
          </li>
          <li>
            <img src={htmlLogo} alt="" className="h-8 w-auto" />
          </li>
          <li>
            <img src={jsLogo} alt="" className="h-8 w-auto" />
          </li>
          <li>
            <img src={mongoLogo} alt="" className="h-8 w-auto" />
          </li>
          <li>
            <img src={nodeLogo} alt="" className="h-8 w-auto" />
          </li>
          <li>
            <img src={postLogo} alt="" className="h-8 w-auto" />
          </li>
          <li>
            <img src={reactLogo} alt="" className="h-8 w-auto" />
          </li>
          <li>
            <img src={tailLogo} alt="" className="h-8 w-auto" />
          </li>
          <li>
            <img src={tsLogo} alt="" className="h-8 w-auto" />
          </li>
        </ul>
      </div>
    </>
